...
(
    ...
    cscript /nologo ~gdownload.vbs https://github.com/gpfnw/goproxy-ci/commits/master ~goproxy_tag.txt
) && (
...
(
    ...
    cscript /nologo ~gdownload.vbs https://github.com/gpfnw/goproxy-ci/releases/download/!remoteversion!/%filename% "~%filename%"
